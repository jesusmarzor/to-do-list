    ...
    return(
        <div className="task">
            ...
            <div className="task__buttons buttons">
                ...
                <svg className="buttons__button" onClick={clickDeleteButton} viewBox="0 0 48 48" width="25px" height="25px"><path fill="#ea899a" d="M21.5 4.5H26.501V43.5H21.5z" transform="rotate(45.001 24 24)"/><path fill="#ea899a" d="M21.5 4.5H26.5V43.501H21.5z" transform="rotate(135.008 24 24)"/></svg>
            </div>
        </div>
    )
}
